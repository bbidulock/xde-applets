...
#define XA_PREFIX		"_XDE_ID_APPLET"
#define XA_SELECTION_NAME	XA_PREFIX "_S%d"
#define LOGO_NAME		"chip"

int saveArgc;
char **saveArgv;

#define RESNAME "xde-id-applet"
#define RESCLAS "XDE-ID-Applet"
#define RESTITL "XDE Input Device Applet"
#define RESCOMM "A input device system tray icon and dock application."
