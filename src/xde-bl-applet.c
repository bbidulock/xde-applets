...
#define XA_PREFIX		"_XDE_BL_APPLET"
#define XA_SELECTION_NAME	XA_PREFIX "_S%d"
#define LOGO_NAME		"notification-display-brightness-full"

int saveArgc;
char **saveArgv;

#define RESNAME "xde-bl-applet"
#define RESCLAS "XDE-BL-Applet"
#define RESTITL "XDE Backlight Applet"
#define RESCOMM "A backlight system tray icon and dock application."
