...
#define XA_PREFIX		"_XDE_CPU_APPLET"
...
#define RESNAME "xde-cpu-applet"
#define RESCLAS "XDE-CPU-Applet"
#define RESTITL "XDE CPU Power Applet"
#define RESCOMM "A cpu power system tray icon and dock application."
