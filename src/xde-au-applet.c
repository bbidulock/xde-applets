...
#define XA_PREFIX		"_XDE_AU_APPLET"
...
#define RESNAME "xde-au-applet"
#define RESCLAS "XDE-AU-Applet"
#define RESTITL "XDE Audio Applet"
#define RESCOMM "A audio system tray icon and dock application."
