...
=head1 NAME
 ...
 xde-hal-applet - a HAL system tray applet

=head1 SYNOPSIS

B< xde-hal-applet> [ I<OPTIONS> ]
 B<xde-hal-applet> --quit [ I<OPTIONS> ]
 B<xde-hal-applet> --replace [ I<OPTIONS> ]
 B<xde-hal-applet> --help [ I<OPTIONS> ]
 B<xde-hal-applet> --version
 B<xde-hal-applet> --copying
...
running session of B<xde-hal-applet>.
...
B<xde-hal-applet> plays the following sounds under the following
...
B<xde-hal-applet> examines the following environment variables:
...
I wrote B<xde-hal-applet> due to the deficiencies and lack of
