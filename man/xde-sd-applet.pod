...
=head1 NAME
 ...
 xde-sd-applet - an Systemd system tray applet

=head1 SYNOPSIS

B< xde-sd-applet> [ I<OPTIONS> ]
 B<xde-sd-applet> --quit [ I<OPTIONS> ]
 B<xde-sd-applet> --replace [ I<OPTIONS> ]
 B<xde-sd-applet> --help [ I<OPTIONS> ]
 B<xde-sd-applet> --version
 B<xde-sd-applet> --copying
...
running session of B<xde-sd-applet>.
...
B<xde-sd-applet> plays the following sounds under the following
...
B<xde-sd-applet> examines the following environment variables:
...
I wrote B<xde-sd-applet> due to the deficiencies and lack of
availability of system tray and window-maker dock application
systemd monitoring and management.
