...
=head1 NAME
 ...
 xde-cpu-applet - an Avahi system tray applet

=head1 SYNOPSIS

 xde-cpu-applet [ OPTIONS ]
 xde-cpu-applet --quit [ OPTIONS ]
 xde-cpu-applet --replace [ OPTIONS ]
 xde-cpu-applet --help [ OPTIONS ]
 xde-cpu-applet --version
 xde-cpu-applet --copying
