...
=head1 NAME
 ...
 xde-cpu-applet - an CPU performance system tray applet

=head1 SYNOPSIS

B< xde-cpu-applet> [ I<OPTIONS> ]
 B<xde-cpu-applet> --quit [ I<OPTIONS> ]
 B<xde-cpu-applet> --replace [ I<OPTIONS> ]
 B<xde-cpu-applet> --help [ I<OPTIONS> ]
 B<xde-cpu-applet> --version
 B<xde-cpu-applet> --copying
...
running session of B<xde-cpu-applet>.
...
B<xde-cpu-applet> plays the following sounds under the following
...
B<xde-cpu-applet> examines the following environment variables:
...
I wrote B<xde-cpu-applet> due to the deficiencies and lack of
