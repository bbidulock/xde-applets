...
=head1 NAME
 ...
 xde-pk-applet - an Package Kit system tray applet

=head1 SYNOPSIS

B< xde-pk-applet> [ I<OPTIONS> ]
 B<xde-pk-applet> --quit [ I<OPTIONS> ]
 B<xde-pk-applet> --replace [ I<OPTIONS> ]
 B<xde-pk-applet> --help [ I<OPTIONS> ]
 B<xde-pk-applet> --version
 B<xde-pk-applet> --copying
...
running session of B<xde-pk-applet>.
...
B<xde-pk-applet> plays the following sounds under the following
...
B<xde-pk-applet> examines the following environment variables:
...
I wrote B<xde-pk-applet> due to the deficiencies and lack of
availability of system tray and window-maker dock application
Archlinux package managers.
