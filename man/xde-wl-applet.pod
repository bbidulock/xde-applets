...
=head1 NAME
 ...
 xde-wl-applet - an Wireless system tray applet

=head1 SYNOPSIS

B< xde-wl-applet> [ I<OPTIONS> ]
 B<xde-wl-applet> --quit [ I<OPTIONS> ]
 B<xde-wl-applet> --replace [ I<OPTIONS> ]
 B<xde-wl-applet> --help [ I<OPTIONS> ]
 B<xde-wl-applet> --version
 B<xde-wl-applet> --copying
...
running session of B<xde-wl-applet>.
...
B<xde-wl-applet> plays the following sounds under the following
...
B<xde-wl-applet> examines the following environment variables:
...
I wrote B<xde-wl-applet> due to the deficiencies and lack of
availability of system tray and window-maker dock application
WiFi managers and controllers.
