...
=head1 NAME
 ...
 xde-dh-applet - a DHCP system tray applet

=head1 SYNOPSIS

B< xde-dh-applet> [ I<OPTIONS> ]
 B<xde-dh-applet> --quit [ I<OPTIONS> ]
 B<xde-dh-applet> --replace [ I<OPTIONS> ]
 B<xde-dh-applet> --help [ I<OPTIONS> ]
 B<xde-dh-applet> --version
 B<xde-dh-applet> --copying
...
running session of B<xde-dh-applet>.
...
B<xde-dh-applet> plays the following sounds under the following
...
B<xde-dh-applet> examines the following environment variables:
...
I wrote B<xde-dh-applet> due to the deficiencies and lack of
