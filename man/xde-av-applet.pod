...
=head1 NAME
 ...
 xde-av-applet - an Avahi system tray applet

=head1 SYNOPSIS

B< xde-av-applet> [ I<OPTIONS> ]
 B<xde-av-applet> --quit [ I<OPTIONS> ]
 B<xde-av-applet> --replace [ I<OPTIONS> ]
 B<xde-av-applet> --help [ I<OPTIONS> ]
 B<xde-av-applet> --version
 B<xde-av-applet> --copying
...
running session of B<xde-av-applet>.
...
B<xde-av-applet> plays the following sounds under the following
...
B<xde-av-applet> examines the following environment variables:
...
I wrote B<xde-av-applet> due to the deficiencies and lack of
availability of system tray and window-maker dock application
avahi/rendevous management and monitoring.
